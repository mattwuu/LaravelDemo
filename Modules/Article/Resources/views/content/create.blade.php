...
@section('content')
    <div class="card" id="app">
        ...
        <ul role="tablist" class="nav nav-tabs">
            <li class="nav-item"><a href="/article/content" class="nav-link" pjax>文章列表</a></li>
                ...
                <div class="row">
                    <div class="col-sm-4 border bg-transparent">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-lg-9">
                                <hd-image name="thumb" id="thumb"
                                          image-url="{!! $content['thumb']??old('thumb') !!}"></hd-image>
                                @if ($errors->has('thumb'))
                    ...
                    <div class="col-sm-8">
                        <div class="form-group row pt-0">
                            {{--<label for="content" class="col-12 col-sm-3 col-form-label text-md-right"--}}
                                   {{--style="padding-top:initial;">内容</label>--}}
                            <div class="col-12">
                                <hd-simditor name="content"
                                             url="/upload-simditor">{{ $content['content']??old('content') }}</hd-simditor>
